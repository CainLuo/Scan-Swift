...
public class PermissionManager: NSObject {
    ...
    //MARK: 获取相册权限
    static public func authorizePhotoWith(comletion: @escaping (Bool, PHAuthorizationStatus) -> Void) {
    ...
    //MARK: 相机权限
    static public func authorizeCameraWith(completion: @escaping (Bool, AVAuthorizationStatus) -> Void) {
    ...
    //MARK: 跳转到APP系统设置权限界面
    static public func jumpToSystemPrivacySetting() {
